...
const navigation = {
  ...
  user: [
    ...
    { name: 'Bibliothèque', href: '/dashboard/library' },
  ...
  admin: [
    ...
    { name: 'Gestion Ressources', href: '/admin/resources' },
    { name: 'Gestion Événements', href: '/admin/events' },
            ...
            {user && (
              <div className="border-t border-gray-200 pb-3 pt-4">
                <div className="space-y-1">
                  ...
                  {isAdmin && navigation.admin.map((item) => (
                    <Disclosure.Button
                      key={item.name}
                      as={Link}
                      to={item.href}
